...
export default function Converter() {
  ...
  const handleConvertToChange = (event) => {
    ...
    let convertedCurrency = event.target.value;
    setConvertTo(convertedCurrency);
  };
  useEffect(() => {
  ...
  const conversion = (id, convertTo) => {
    fetch(
      `https://api.exchangeratesapi.io/latest?base=${id}&symbols=${convertTo}`
    )
